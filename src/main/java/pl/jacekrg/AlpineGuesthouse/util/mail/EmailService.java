package pl.jacekrg.AlpineGuesthouse.util.mail;
...
public class EmailService {
    ...
    @Value("${AlpineGuesthouse.protocol}")
    private String protocol;

    @Value("${AlpineGuesthouse.domain}")
    private String domain;

    @Value("${AlpineGuesthouse.port}")
    private String port;
    ...
    public void sendConfirmationEmail(String email, long reservationId) {
        ...
        mail.setTo(email);
        mail.setFrom("cebuleczka@wir.pl");
