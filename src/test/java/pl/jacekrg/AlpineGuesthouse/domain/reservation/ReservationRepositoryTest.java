...
import pl.jacekrg.AlpineGuesthouse.domain.guest.GuestRepository;
import pl.jacekrg.AlpineGuesthouse.domain.room.BedType;
import pl.jacekrg.AlpineGuesthouse.domain.room.Room;
import pl.jacekrg.AlpineGuesthouse.domain.room.RoomRepository;
...
public class ReservationRepositoryTest {
    ...
    public void getConfirmed() {
        ...
        Guest g1 = new Guest("Robert", "Kubica", LocalDate.now());
        Guest g2 = new Guest("Jan", "Kowalski", LocalDate.now());
